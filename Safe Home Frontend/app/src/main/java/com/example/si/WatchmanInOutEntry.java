...
public class WatchmanInOutEntry extends AppCompatActivity {
    SharedPreferences sharedPreferences;
    SharedPreferences.Editor editor;
    ArrayList<LastActivity> inoutentryArrayList;
    ListView listView;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        inoutentryArrayList=new ArrayList<>();
    ...
    public void loadData() {
        String url = Constant.URL + "everydayinout" + "/" + secretaryPhoneNumber;
        RequestQueue requestQueue = Volley.newRequestQueue(WatchmanInOutEntry.this);
...
//                        editor.putString("phoneNumber",phoneNumber);
                        inoutentryArrayList.add(lastActivity);
                    }
                    LastActivityAdapter lastActivityAdapter = new LastActivityAdapter(WatchmanInOutEntry.this,inoutentryArrayList);
